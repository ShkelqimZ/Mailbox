    ...
    <div class="col-md-9 col-sm-9">
        <div class="row">
            ...
            <div class="btns">
                ...
                <button ng-click="deleteThisInboxMail(<?php echo $inbox_details[0]->inbox_id; ?>)"><i class="fa fa-trash fa-1x" style="font-size:30px; margin:auto;"></i></button>
            </div>
            </div>
        </div>
        <div id="mail-table">
            <h3 class="text-center">{{$inbox_details[0]->subject}}</h3>
            <hr>
            <span><strong>From:</strong> {{$inbox_details[0]->name}} {{$inbox_details[0]->last_name}}</span>
            <div class="message">
